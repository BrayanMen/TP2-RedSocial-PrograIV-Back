...
* `GET /api/v1/posts` - Listar publicaciones (con queries para paginación, orden y filtro)
* `DELETE /api/v1/posts/:id` - Eliminar publicación (baja lógica)
* `POST /api/v1/posts/:id/like` - Dar "me gusta" a una publicación
* `DELETE /api/v1/post/:id/like` - Quitar "me gusta"
...
* `GET /api/v1/posts/:id/comments` - Listar comentarios de un post (con paginación)
* `POST /api/v1/posts/:id/comments` - Agregar un comentario
...
* [ ] `POST /api/v1/admin/users/:id/active` - Activar usuario (alta lógica).
